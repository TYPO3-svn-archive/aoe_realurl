...
class tx_aoerealurlpath_hooks_crawler {
	...
	function insertPageIncache(&$pObj, $timeOutTime) {
		...
		if (t3lib_extMgm::isLoaded ( 'crawler' ) && $pObj->applicationData ['tx_crawler'] ['running'] && in_array ( 'tx_cachemgm_recache', $pObj->applicationData ['tx_crawler'] ['parameters'] ['procInstructions'] )) {
